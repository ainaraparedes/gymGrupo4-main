        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstaActivo = table.Column<bool>(type: "bit", nullable: false),
                    SuscripcionId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clientes_Suscripciones_SuscripcionId1",
                        column: x => x.SuscripcionId1,
                        principalTable: "Suscripciones",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clientes_SuscripcionId1",
                table: "Clientes",
                column: "SuscripcionId1");
